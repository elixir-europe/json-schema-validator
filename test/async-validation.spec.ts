...
import IsChildTerm  from "../src/keywords/ischildtermof";

describe("Async validations tests", () => {
    test(" -> isChildTermOf Schema", () => {
        ...
        const elixirValidator = new ElixirValidator([new IsChildTerm('https://www.ebi.ac.uk/ols/api/search?q=')]);
